...
class _ProfilePageState extends State<ProfilePage> {
  ...
  final TextEditingController _emailController = TextEditingController(
    text: 'melissa@datacenterspecialists.com',
  );
                            ...
                            onPressed: () {
                              setState(() {
                                ...
                                _addressController.text = [
                                  ...
                                  '${_postcodeController.text} ${_cityController.text}'
                                      .trim(),
                                                  ...
                                                  setState(() {
                                                    if (!_phoneController.text
                                                      ...
                                                      _phoneController.text =
                                                          '+60 ${_phoneController.text.replaceAll(RegExp(r'^\+\d+\s*'), '')}';
                                                    }
                                                  });
                                                ...
                                                onTap: () {
                                                  setState(() {
                                                    if (!_phoneController.text
                                                        .startsWith('+65')) {
                                                      _phoneController.text =
                                                          '+65 ${_phoneController.text.replaceAll(RegExp(r'^\+\d+\s*'), '')}';
                                                    }
                                                  });
                                                  Navigator.pop(context);
                                                },
