...
class _PersonalPageState extends State<PersonalPage> {
  ...
  final List<DocumentFile> _myFiles = [
    DocumentFile(
      ...
      requiredActions: 3,
      uploadedFiles: ['Passport_1.pdf', 'Passport_2.pdf', 'Passport_3.pdf'],
    ),
    DocumentFile(
      title: 'Notice of Assessment 2023',
      subtitle: 'IRAS Personal Tax • PDF',
      badgeText: 'Progress',
      requiredActions: 3,
      uploadedFiles: ['NOA_1.pdf', 'NOA_2.pdf'],
    ),
    DocumentFile(
      title: 'Rental Agreement',
      subtitle: 'Property & Real Estate • PDF',
      badgeText: 'Pending',
      requiredActions: 3,
      uploadedFiles: [],
    ),
